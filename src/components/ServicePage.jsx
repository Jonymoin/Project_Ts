...
const ServicePage = () => {
  ...
  const services = [
    ...
    { id: 10, name: "Dishwasher Repair Services", description: "Is your dishwasher acting up? Our expert dishwasher repair services in Singapore are here to help! From water drainage issues and faulty spray arms to electrical problems and strange noises, we diagnose and fix all types of dishwasher malfunctions. Our skilled technicians work with all major brands, using quality tools and parts to ensure long-lasting solutions. Save time and money by restoring your dishwasher to perfect working condition instead of replacing it. Trust us for quick, reliable, and affordable repair services. Contact us today to get your dishwasher running smoothly again!" },
