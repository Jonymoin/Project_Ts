...
const ServicePage = () => {
  ...
  return (
    <main>
      {backgroundImage && (
        <div
          className="h-[400px] flex flex-col items-center justify-center text-white"
          style={{
      ...
      <div className="font-roboto text-white py-4">
