...
const ServicePage = () => {
  ...
  return (
    <main>
      {backgroundImage && (
       <div
       className="h-[400px] flex flex-col items-center bg- justify-center text-white "
       style={{
