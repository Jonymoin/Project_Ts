...
const Footer = () => {
  ...
  />
    ...
    />
        ...
        <div className='w-36 h-1 bg-[#cf0] ml-3'></div>
          <ul className='text-xl space-y-3 ml-46 mt-4'>
          <li>
            
            <Link to="/about" className='flex items-center gap-2 hover:text-[#cf0]'><TbArrowBigRightLinesFilled /> About Us</Link>
          </li>
          <li>
            
            <Link to="/privacypolicy" className='flex items-center gap-2 hover:text-[#cf0]'><TbArrowBigRightLinesFilled/> Privacy Policy</Link>
          </li>
          <li>
            
            <Link to="/terms&conditions" className='flex items-center gap-2 hover:text-[#cf0]'><TbArrowBigRightLinesFilled/> Terms & Conditions</Link>
          </li>
          </ul>
        </div>
        <div className='service'>
            ...
            <div className='w-36 h-1 bg-[#cf0] ml-10'></div>
            <ul className='grid grid-cols-1 gap-3 mt-5'>
            {services.map((service) => (
                <li key={service.id} className="py-2 px-4 hover:bg-[#cf0] transition-all duration-100 rounded-xl">
        ...
        <div className='contact space-y-5'>
            ...
            <div className='w-36 h-1 bg-[#cf0]'></div>
