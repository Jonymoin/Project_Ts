            ...
            <div className="absolute inset-0 z-20 flex items-center justify-center text-center px-4">
              <div className="max-w-4xl">
                ...
                <div className="flex gap-4 justify-center">
                  <a href="https://wa.me/6590574832" target="_blank" rel="noopener noreferrer" className="bg-blue-600 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-blue-700 transition transform hover:scale-105">
                    Get Free Quote
                  </a>
                  <a href="tel:+6590574832" className="bg-white text-gray-900 px-8 py-4 rounded-lg text-lg font-semibold hover:bg-gray-100 transition transform hover:scale-105">
                    Call Now
                  </a>
                </div>
              </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col md:flex-row gap-6 justify-center items-center">
            ...
            <div className="flex items-center gap-3">
              ...
              <a href="https://wa.me/6590574832" target="_blank" rel="noopener noreferrer" className="text-xl font-semibold hover:underline">
                WhatsApp Us
              </a>
            </div>
            <div className="flex items-center gap-3">
